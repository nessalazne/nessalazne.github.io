...
This is where most people start. You go to [claude.ai](https://claude.ai), type a message, and Claude responds. Think of it like a very smart conversation partner.
...
1. **Claude.ai** — quick research and ideation
2. **Claude Cowork** — build and refine your prompts and skills inside a branded project
3. **Claude Code** — run those same skills as automated pipelines that write, publish, and distribute your content
